package com.servlet.abandon;

import com.module.DeanApproval;
import com.module.Students;
...
public class TeacherDashboardServlet extends HttpServlet {
    ...
    private List<Teacher> getTeacherFromDatabase(){
        ...
        /*private List<Topic> getQuestionsFromDatabase () {
            // 实际实现数据库查询
    ...
    private List<Topic> getQuestionsFromDatabase () throws ServletException {
